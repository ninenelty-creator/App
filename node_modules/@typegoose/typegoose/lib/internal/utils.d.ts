 ...
 * @param loggerType Type to use for logging
 */
export declare function mapOptions(rawOptions: any, Type: AnyParamConstructor<any> | (mongoose.Schema & IPrototype), target: any, pkey: string, modelOptions: IModelOptions, loggerType?: AnyParamConstructor<any>): MappedInnerOuterOptions;
/**
